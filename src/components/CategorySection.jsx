  ...
  return (
    <div className="mb-3 bg-white border border-zinc-200 rounded-xl overflow-hidden shadow-sm">
      {!isOnlySection && (
        <div className="flex items-center justify-between px-5 py-3 border-b border-zinc-100 bg-zinc-50 group/lbl">
          ...
          <button
            ...
            className="focus-light opacity-0 group-hover/lbl:opacity-100 text-zinc-400 hover:text-red-500 text-xs font-semibold transition-all ml-4"
          >
            Remove
          </button>
        </div>
      ...
      {!isOnlySection && section.items.length > 0 && (
        <div className="flex justify-end px-5 py-3 border-t border-zinc-100 bg-zinc-50">
