...
export default function EstimatorHeader({ page, setPage, view, setView, onLoadPreset }) {
  ...
  return (
    ...
    >
      {/* Wordmark lockup: [logo] Studio | Estimator */}
      <div className="flex items-center gap-2.5 flex-shrink-0">
        <img src="/lh-logo.png" alt="Little House" className="h-6 w-auto" style={{ filter: 'brightness(0) invert(1)' }} />
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        {page === 'estimator' && !isClient && <PresetLoader onLoad={onLoadPreset} />}
